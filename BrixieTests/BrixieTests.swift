...
// MARK: - Legacy Test// MARK: - Mock Data Sources
...
struct SearchViewModelTests {
    ...
    func testLoadRecentSearchesOnInit() async throws {
        ...
        let mockLegoSetRepo = MockBoundedLegoSetRepository()
        let mockLegoThemeRepo = MockBoundedLegoThemeRepository()
...
@MainActor
final class MockBoundedLegoSetRepository: LegoSetRepository {
    func fetchSets(page: Int, pageSize: Int) async throws -> [LegoSet] {
...
@MainActor
final class MockBoundedLegoThemeRepository: LegoThemeRepository {
    func fetchThemes(page: Int, pageSize: Int) async throws -> [LegoTheme] {
        return []
    }
...
struct SearchDebounceTests {
    ...
    func testDebouncedSearchDelay() async throws {
        let mockRepo = DebounceTestLegoSetRepository()
        let mockThemeRepo = DebounceTestLegoThemeRepository()
        let viewModel = SearchViewModel(
...
// MARK: - Debounce Test Mock Repositories

@MainActor
final class DebounceTestLegoSetRepository: LegoSetRepository {
...
@MainActor
final class DebounceTestLegoThemeRepository: LegoThemeRepository {
    func fetchThemes(page: Int, pageSize: Int) async throws -> [LegoTheme] {
        return []
    }
